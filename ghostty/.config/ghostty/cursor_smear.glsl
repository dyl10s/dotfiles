...
const vec4 TRAIL_COLOR = vec4(0.8, 0.65, 0.97, 0.15); // Catppuccin mauve #cba6f7, low opacity
const vec4 CURRENT_CURSOR_COLOR = TRAIL_COLOR;
const vec4 PREVIOUS_CURSOR_COLOR = TRAIL_COLOR;
const vec4 TRAIL_COLOR_ACCENT = vec4(1.0, 1.0, 1.0, 0.2); // white, low opacity
...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
    ...
    if (isFarEnough && isOnSeparateLine) {
        ...
        // Removed glow accent, just the trail
